...
//        request.setTemplateGroupId("78fffb8c0c2426efd5baaaafed76fe36");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4G8HQfeJzyabpAerFa8P";
        //您的AccessKeySecret
        String accessKeySecret = "nerm8OLhiB5QY3K6NNGJtDLSDFxzLN";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "/home/yuze/视频/ttest.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "ttest.mp4";
